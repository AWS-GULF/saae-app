...
export default function Services() {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      img: newInvestor,
      title: t('services_new_investor_title'),
      desc: t('services_new_investor_desc'),
    },
    {
      id: "Industrial-Services-Studies",
      img: last,
      title: t('services_industrial_services_title'),
      desc: t('services_industrial_services_desc'),
    },
