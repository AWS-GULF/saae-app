...
//                 <div className="bg-gray-50  overflow-hidden mb-4 border-2 border-[#BCB2CC] rounded-[8px] ">
...
//                                         <div key={job.id} className="p-2  flex items-center justify-between border-[#BCB2CC] bg-[#D5C6DE] rounded-[6px] hover:bg-gray-50 border mb-2">
//                                             <span className="text-purple-700 font-medium">{job.title} (Code: {job.code})</span>
//                                             <button
//                                                 onClick={() => handleViewDetails(job)}
//                                                 className="bg-[#764895] text-white px-4 py-2 rounded font-medium hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 text-sm"
//                                             >
//                                                 View Details
//                                             </button>
//                                         </div>
...
//                         <div className="bg-white rounded-lg overflow-hidden w-full flex "> 
//                             <button
//                                 onClick={() => toggleSection('technical')}
//                                  className="p-2  w-full text-start flex items-center justify-between border-[#BCB2CC] bg-[#EAE4EF] rounded-[6px] border mb-2"
//                             >
//                                 <p className="font-[400]  text-[#30086B] text-lg flex justify-center items-center">Technology & Digital Solutions</p>
